            ...
            public void onClick(View v) {//show btn
                ...
                switch (cptShow){
                    ...
                    case 2:
                        ...
                        fullSpanneble.setSpan(new RelativeSizeSpan(1.9f),BissmilahPos,BissmilahPos+"سورة القلم".length(),Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                        fullSpanneble.setSpan(new ForegroundColorSpan(Color.BLACK),BissmilahPos,BissmilahPos+"سورة القلم".length(),Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                        fullSpanneble.setSpan(new StyleSpan(Typeface.BOLD),BissmilahPos,BissmilahPos+"سورة القلم".length(),Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
