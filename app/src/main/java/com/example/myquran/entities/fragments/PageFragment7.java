...
public class PageFragment7 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        subStringList.add("(35)");
        subStringList.add("(36)");
        subStringList.add("(37)");
        subStringList.add("(38)");
        subStringList.add("(39)");
        subStringList.add("(40)");
        subStringList.add("(41)");
        subStringList.add("(42)");
        subStringList.add("(43)");
        subStringList.add("(44)");
        subStringList.add("(45)");
        subStringList.add("(46)");
        subStringList.add("(47)");
        subStringList.add("(48)");
        subStringList.add("(49)");
        subStringList.add("(50)");
        subStringList.add("(51)");
        subStringList.add("(52)");
