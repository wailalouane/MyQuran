...
public class PageFragment5 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(Functions.thereIsStat(numero,surhText)){
            ...
            int startIndex =fullText.indexOf(subStringList.get(10));
            fullSpannable.setSpan(new ForegroundColorSpan(Color.BLACK),startIndex,startIndex+subStringList.get(10).length(),Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            startIndex =fullText.indexOf(subStringList.get(11));
            fullSpannable.setSpan(new ForegroundColorSpan(Color.BLACK),startIndex,startIndex+subStringList.get(11).length(),Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            for (int i :Functions.GetPosAyah(json)){
                ...
                switch (cptShow){
                    ...
                    case 0:
                        ...
                        for (int i = 0; i <subStringList.size()-1 ; i++) {
                            ...
                            if (i==11) {//  ayah after the bassmallah
                    ...
                    case 2:
                        ...
                        fullSpannable.setSpan(new RelativeSizeSpan(1.9f),BissmilahPos,BissmilahPos+"سورة الحاقة".length(),Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                        fullSpannable.setSpan(new ForegroundColorSpan(Color.BLACK),BissmilahPos,BissmilahPos+"سورة الحاقة".length(),Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                        fullSpannable.setSpan(new StyleSpan(Typeface.BOLD),BissmilahPos,BissmilahPos+"سورة الحاقة".length(),Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
